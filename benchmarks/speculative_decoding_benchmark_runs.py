"""
Suggested speculative-decoding benchmark runs.

Use this with the benchmark file that defines:

    run_kv_vs_speculative_decoding_benchmark(...)

How to use:
1. Import this file near the bottom of nanogpt-spec-decode.py:
...
different draft depths and draft quality levels.
"""
...
def run_speculative_decoding_benchmark_suite(
    model,
    *,
    vocab_size,
    device,
    ...
    """
    Run KV-cache vs speculative-decoding comparisons.
    ...
    for config in configs:
        ...
        results[name] = run_kv_vs_speculative_decoding_benchmark(
            model,
            vocab_size=vocab_size,
